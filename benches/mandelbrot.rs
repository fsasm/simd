...
#[cfg(any(target_feature = "avx", target_feature = "avx2", target_feature = "fma"))]
...
fn fma8(c_x: f32x8, c_y: f32x8, max_iter: u32) -> u32x8 {
    let mut x = c_x;
    let mut y = c_y;
...
#[cfg(target_feature = "fma")]
fn fma4(c_x: f32x4, c_y: f32x4, max_iter: u32) -> u32x4 {
    let mut x = c_x;
    let mut y = c_y;
